        ...
        <ul class="list">
          <li v-for="item in state.data">
            <ul class="clearfix">
              ...
              <li>
                <span>原舱位:</span>
                <span>{{ item.flightSeatOrigin }}</span>
              </li>
              <li>
                <span>升舱后舱位:</span>
                <span>{{ item.flightSeatDest }}</span>
              </li>
              <li>
                <span>操作内容:</span>
                <span>{{ item.operContent }}</span>
              </li>
              <li style="width: 96%">
                <span>操作时间:</span>
